...
'''
    Script for loading configuration to u-blox GNSS receivers from a .txt config file generated by u-center (Tools -> Receiver Configuration)
    So far only supports receivers which use VALGET/VALSET based configuration (e.g. ZED-F9P)
'''
...
if len(sys.argv) < 4:
    ...
    print ("Example usage: {} /dev/ttyACM0 115200 config.txt".format(sys.argv[0]))
    sys.exit()
...
print ("Reading config from {}".format(CFG_FILE))
try:
...
for line in cfgLines:
    ...
    if "MON-VER" in line:
        ...
        # print ("Firmware version of the config file: {}".format(config_fwVersion))
